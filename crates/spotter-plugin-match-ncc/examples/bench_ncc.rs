...
//!
//! Usage: cargo run -p spotter-plugin-match-ncc --release --example bench_ncc -- HAY NEEDLE

use spotter_base::MatchOptions;
use spotter_core::load_rgba_from_path;
...
fn bench(label: &str, hay: &spotter_base::RgbaImage, needle: &spotter_base::RgbaImage, opts: MatchOptions) {

...
//!
//! Run: `cargo test -p spotter-plugin-match-ncc --test ncc_synthetic_scenarios`

mod common;

use common::fixtures::{self, Scenario};
use spotter_base::{MatchOptions, MatchPlugin, Region, SpotterError};
use spotter_plugin_match_ncc::{find_best, find_best_serial, prepare_needle, rgba_to_gray};
...
fn fast_serial_agree(hay: &spotter_base::RgbaImage, needle: &spotter_base::RgbaImage, opts: &MatchOptions) {

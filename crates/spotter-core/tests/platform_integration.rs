//! Desktop integration tests — run with `cargo test -p spotter-core -- --ignored`.

use spotter_core::{capture_screen, clipboard_get, clipboard_set, screen_size, SpotterError};

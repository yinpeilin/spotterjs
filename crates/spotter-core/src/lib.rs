...
pub use matcher::{
    ...
    find_template_in_haystack_rgba, find_template_in_window,
    find_template_in_window_with_needle, find_template_with_needle, translate_region,
    wait_for_template, wait_for_template_buffers,
